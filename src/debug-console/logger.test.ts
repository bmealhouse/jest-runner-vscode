...
test('returns obsolete snapshot summary (sigular)', () => {
  expect(
    ...
    `" [1m[33m› 1 snapshot obsolete[0m[0m from 1 test suite. [90mTo remove them all, re-run jest with \`JEST_RUNNER_VSCODE_UPDATE_SNAPSHOTS=true\`.[0m"`,
  )
})
...
test('returns obsolete snapshot summary (plural)', () => {
  expect(
    ...
    `" [1m[33m› 2 snapshots obsolete[0m[0m from 2 test suites. [90mTo remove them all, re-run jest with \`JEST_RUNNER_VSCODE_UPDATE_SNAPSHOTS=true\`.[0m"`,
  )
})
...
test('returns failed snapshot summary (sigular)', () => {
  expect(
    ...
    `" [1m[31m› 1 snapshot failed[0m[0m from 1 test suite. [90mInspect your code changes or re-run jest with \`JEST_RUNNER_VSCODE_UPDATE_SNAPSHOTS=true\` to update them.[0m"`,
  )
})
...
test('returns failed snapshot summary (plural)', () => {
  expect(
    ...
    `" [1m[31m› 2 snapshots failed[0m[0m from 2 test suites. [90mInspect your code changes or re-run jest with \`JEST_RUNNER_VSCODE_UPDATE_SNAPSHOTS=true\` to update them.[0m"`,
  )
})
